...
const BENEFITS = ["Every level unlocked — 400+ and growing","No ads, ever","Unlimited undo and three free hints a day","The daily challenge archive"];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top }}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl, paddingBottom: spacing['3xl'] }}>
        <Text variant="display">PourSort Pro</Text>
        <Text variant="body" tone="muted" style={{ marginTop: spacing.sm }}>
          Pour until every tube holds one colour. No timer, no fail state.
        </Text>
