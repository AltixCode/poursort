...
/**
 * Store identity and native configuration for PourSort.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and PourSort works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.poursort',
    buildNumber: BUILD,
    supportsTablet: true,
  ...
  android: {
    package: 'com.altixcode.poursort',
