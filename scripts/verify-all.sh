...
step 'iOS bundle'
npx expo export --platform ios --output-dir "${TMPDIR:-/tmp}/poursort-verify-ios" >/dev/null

step 'Android bundle'
npx expo export --platform android --output-dir "${TMPDIR:-/tmp}/poursort-verify-android" >/dev/null
